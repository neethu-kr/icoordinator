...
$cli = new Application('iCoordinator Create Folder Tree State Command Line Interface');
...
$cli->addCommands(array(
    new \iCoordinator\Console\Command\SystemFunctions\CreateFoldersStateCommand()
));
