...
$cli = new Application('iCoordinator Create Workspace State Command Line Interface');
...
$cli->addCommands(array(
    new \iCoordinator\Console\Command\SystemFunctions\CreateWorkspaceStateCommand()
));
